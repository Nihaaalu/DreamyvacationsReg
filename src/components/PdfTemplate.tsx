...
export default function PdfTemplate({ formData, logoError, setLogoError }: PdfTemplateProps) {
  ...
  return (
    <div id="a4-sheet" className="a4-sheet-offscreen">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #523f28', paddingBottom: '24px', marginBottom: '32px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '24px' }}>
          {!logoError ? (
            ...
            <div style={{ height: '112px', width: '112px', backgroundColor: '#523f28', color: '#ffffff', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        <div style={{ textAlign: 'right', fontFamily: "'Inter', sans-serif" }}>
          <span style={{ display: 'block', fontSize: '13px', fontWeight: '600', textTransform: 'uppercase', color: '#1e293b', marginTop: '6px', letterSpacing: '0.5px' }}>
      ...
      <div className="pdf-section">
        <h2 className="pdf-section-title">
          Suites & Occupancy Details
        </h2>

        <div className="luxury-accommodation-card">
          <div className="luxury-card-col" style={{ borderRight: '1px solid #94a3b8', paddingRight: '24px' }}>
      ...
      <div className="luxury-pdf-footer">
        <div className="luxury-footer-date-container">
          <span className="luxury-footer-date-lbl">Date:</span>
          <span className="luxury-footer-date-val">{formatToLuxuryDate(formData.arrivalDate)}</span>
        </div>

        <div className="luxury-footer-sig-container">
          <span className="luxury-footer-sig-lbl">Guest Signature:</span>
          <div className="luxury-footer-sig-line"></div>
        </div>
      </div>
    </div>
  );
